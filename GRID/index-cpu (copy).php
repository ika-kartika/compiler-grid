...
$query="update grid_computer set cpu_usage='$cpu',time='$now' where ip_address='192.168.1.10'";
$statement=oci_parse($c,$query);
oci_execute($statement);

$q_lihat_grid="select id_computer,computer_name,ip_address,cpu_usage,time from grid_computer where ip_address='192.168.1.10' order by id_computer asc";
